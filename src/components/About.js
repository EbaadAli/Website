      ...
      <section id="about">
         <div className="row">
            ...
            <div className="three columns">
               ...
               <img className="profile-pic"  src="images/me.png" alt="A pic of me" />
            ...
            <div className="nine columns main-col">
               ...
               <h2>Download my resume</h2><h3><a className="buttonDownload" href="images/Ebaad_Ali_Resume.pdf" download> Here </a></h3> 
